...
def args_parser():
    ...
    parser.add_argument('--checkpointsmodelfile', type=str, default='E:\code\HyBenchmark(1)\checkpoints\lssan\Houston\model_77.58.pth')
        ...
        for i in range(height):
            for j in range(width):
                if args.allimg:
                    ...
                    X_test_image = X_test_image.squeeze(1)
